...
public abstract class TaskPool<E> {
	...
	protected List<E> waitingForThisBatchFinishIfNecessory() {
		return waitingForThisBatchFinish(batchSize);
	}

	protected List<E> waitingForThisBatchFinish(int batchSize) {
