...
public class ElementForHuihuiPriceHistory extends TextProcessing {

	Pattern p = Pattern.compile("purl=([^&]+)");

	@Override
	public String parse(PageFetcherAbstract fetcher, String domToHtml) throws SAXException, IOException, XPathExpressionException,
