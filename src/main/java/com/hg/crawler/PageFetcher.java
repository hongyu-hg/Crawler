...
public class PageFetcher extends PageFetcherAbstract {
    /**
     * single Xpath list for the single point content, all the Xpath result in
     * the same line.
     */
    private List<Xpath> singleXpathList;
    /**
     * extend multiple lines, for each patched parent Xpath
     */
    private Xpath parentXpath;
    /**
     * finding the children elements in each parent xpath, it will not extend
     * more lines.
     */
    private List<Xpath> childXpathList;
    /**
     * deal with the pages have pagination. special the page links.
     */
